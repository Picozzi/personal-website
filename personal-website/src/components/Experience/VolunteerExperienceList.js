const json = {
  jobs: [
    ...
    },
    {
      ...
      jobDescription:
        "Manager of the marketing efforts of the University of Waterloo's autonomous car team. Also, is a member of the telemetry team.",
      ...
      jobColor: "#36c4e6",
      jobPoints: [
        "Assisted in testing the CAN interface for a level 4 autonomous vehicle which will compete in the SAE AutoDrive Challenge.",
