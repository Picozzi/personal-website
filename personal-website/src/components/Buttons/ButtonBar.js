...
const ButtonBar = () => {
  ...
  return (
    ...
    >
      <a
        href="https://github.com/Picozzi"
        target="_blank"
        rel="noopener noreferrer"
      >
        <Button animated="vertical">
          <Button.Content visible>{gitHubRender}</Button.Content>
          <Button.Content hidden>GitHub</Button.Content>
        </Button>
      </a>
      <a
        href="https://ca.linkedin.com/in/matthewpicozzi"
        target="_blank"
        rel="noopener noreferrer"
      >
        <Button animated="vertical">
          <Button.Content visible>{linkedInRender}</Button.Content>
