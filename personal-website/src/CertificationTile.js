...
const CertificationTile = (props) => {
    ...
    const [rotationBack, setRotationBack] = useState(180);
      ...
      return (
              ...
              onHoverStart= {() => {setRotationFront(rotationFront-180); setRotationBack(rotationBack-180); console.log('HI');}}
              >  
            ...
            transition={{ duration: 2 }}
            onHoverEnd={() => {setRotationFront(rotationFront+180); setRotationBack(rotationFront+360); console.log("Bye") }}
            >
            <h2>Issued: <span>{props.certificate.certificateDate}</span></h2>
            <h2>Issued By: <span>{props.certificate.certificateOrganization}</span></h2>
            <h2><span>{props.certificate.certificateDescription}</span></h2>
            {props.certificate.certificateLink != null ? 
            <a href={props.certificate.certificateLink} target="_blank" rel="noopener noreferrer"><h2>Click Here to View Certificate</h2></a> : null }
           </BackTile>
            </Tile>
