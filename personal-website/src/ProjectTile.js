...
const IsTooSmall =  useMediaQuery({ query: '(min-width: 600px)' });
      ...
      return (
              ...
              <h2>{props.project.projectDescription}</h2>
                ...
                <div key={key} className="ui label">{label}</div>
                ))}
                </LabelDiv>
                {
                    IsTooSmall ? <ButtonList code={props.project.projectSource} app={props.project.projectApp}/>
                    : <LinkDiv><a href={props.project.projectSource} target="_blank" rel="noopener noreferrer"><h2>Code</h2></a>
                    <a href={props.project.prokectApp} target="_blank" rel="noopener noreferrer"><h2>Application</h2></a>
                    </LinkDiv>
                }
              </TileInformation>
              </Base>
