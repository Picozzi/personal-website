...
import { thumbnailVariants, cardContentVariants, contentVariants} from './variants';
import './App.css';
...
const InitalCard = ({
    ...
    >
      ...
      variants={contentVariants}>
        ...
        <h3>{data.jobDetails}<br/>{data.jobLocation}</h3>
        ...
        {data.jobExpanded ? 
        <a onClick={() => onClick(true)}>Click Here to Learn More</a> : null
        }
    </InitalCardContent>
    </CardBase>
  );
